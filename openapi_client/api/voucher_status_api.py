...
class VoucherStatusApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.check_voucher_endpoint = _Endpoint(
            settings={
                'response_type': (VOUCHERCHECKRESPONSE,),
                'auth': [],
                'endpoint_path': '/api/v4.0/vouchers/multiple/status/{refId}',
    ...
    def check_voucher(
        ...
        **kwargs
        ...
        >>> thread = api.check_voucher(x_gi_authorization, ref_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['ref_id'] = \
            ref_id
        return self.check_voucher_endpoint.call_with_http_info(**kwargs)
