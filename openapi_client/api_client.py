...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BrandsApi()
        api_instance.brands_by_products  # this is an instance of the class Endpoint
        api_instance.brands_by_products()  # this invokes api_instance.brands_by_products.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.brands_by_products.callable or self.callable in this class
