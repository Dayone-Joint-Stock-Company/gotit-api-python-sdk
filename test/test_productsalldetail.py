...
class TestPRODUCTSALLDETAIL(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PRODUCTSALLDETAIL:
        """Test PRODUCTSALLDETAIL
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PRODUCTSALLDETAIL`
        """
        model = PRODUCTSALLDETAIL()
        if include_optional:
            return PRODUCTSALLDETAIL(
                product_id = 2782,
    ...
    def testPRODUCTSALLDETAIL(self):
        """Test PRODUCTSALLDETAIL"""
