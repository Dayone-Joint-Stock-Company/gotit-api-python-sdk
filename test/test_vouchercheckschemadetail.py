...
class TestVOUCHERCHECKSCHEMADETAIL(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOUCHERCHECKSCHEMADETAIL:
        """Test VOUCHERCHECKSCHEMADETAIL
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOUCHERCHECKSCHEMADETAIL`
        """
        model = VOUCHERCHECKSCHEMADETAIL()
        if include_optional:
            return VOUCHERCHECKSCHEMADETAIL(
