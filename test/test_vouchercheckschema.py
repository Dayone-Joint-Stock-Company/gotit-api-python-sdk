...
class TestVOUCHERCHECKSCHEMA(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOUCHERCHECKSCHEMA:
        """Test VOUCHERCHECKSCHEMA
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOUCHERCHECKSCHEMA`
        """
        model = VOUCHERCHECKSCHEMA()
        if include_optional:
            return VOUCHERCHECKSCHEMA(
