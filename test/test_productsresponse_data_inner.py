...
class TestPRODUCTSRESPONSEDataInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PRODUCTSRESPONSEDataInner:
        """Test PRODUCTSRESPONSEDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PRODUCTSRESPONSEDataInner`
        """
        model = PRODUCTSRESPONSEDataInner()
        if include_optional:
            return PRODUCTSRESPONSEDataInner(
                product_list = [
                    gotit_api_python_sdk.models.products_all_detail.PRODUCTS_ALL_DETAIL(
                        product_id = 2782, 
                ...
                pagination = gotit_api_python_sdk.models.paging_schema.PAGING_SCHEMA(
                    page_size = 1, 
                    page = 1, 
                    total_page = 1, )
            )
