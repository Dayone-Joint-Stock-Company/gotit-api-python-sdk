...
class TestPRODUCTSRESPONSE(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PRODUCTSRESPONSE:
        """Test PRODUCTSRESPONSE
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PRODUCTSRESPONSE`
        """
        ...
        if include_optional:
            return PRODUCTSRESPONSE(
                ...
                message = '',
                data = [
                    gotit_api_python_sdk.models.products_response_data_inner.PRODUCTS_RESPONSE_data_inner(
                        product_list = [
