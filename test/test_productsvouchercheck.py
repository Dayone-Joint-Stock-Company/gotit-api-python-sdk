...
class TestPRODUCTSVOUCHERCHECK(unittest.TestCase):
    """PRODUCTSVOUCHERCHECK unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PRODUCTSVOUCHERCHECK:
        """Test PRODUCTSVOUCHERCHECK
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PRODUCTSVOUCHERCHECK`
        """
        model = PRODUCTSVOUCHERCHECK()
        if include_optional:
            return PRODUCTSVOUCHERCHECK(
                product_id = 1408,
                product_nm = 'Thẻ Quà Tặng Đa Năng',
                ...
                total_store = 1174,
                store_pagination = gotit_api_python_sdk.models.store_paging_schema.STORE_PAGING_SCHEMA(
                    page = 1, 
                    page_size = 1, 
                    total_page = 1174, )
            )
    ...
    def testPRODUCTSVOUCHERCHECK(self):
        """Test PRODUCTSVOUCHERCHECK"""
