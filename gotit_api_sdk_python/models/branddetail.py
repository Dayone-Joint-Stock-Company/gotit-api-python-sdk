...
class BRANDDETAIL(BaseModel):
    ...
    brand_addr: Optional[StrictStr] = Field(default=None, description="Address of brand", alias="brandAddr")
    ...
    short_desc: Optional[StrictStr] = Field(default=None, description="Brand short description", alias="shortDesc")
    description: Optional[StrictStr] = Field(default=None, description="Brand description")
    ...
    service_guide: Optional[StrictStr] = Field(default=None, description="Describe the brand's terms of reference (T&C). HTML format", alias="serviceGuide")
    ...
    __properties: ClassVar[List[str]] = ["brandId", "brandNm", "brandAddr", "brandLogo", "slug", "shortDesc", "description", "categoryID", "order", "serviceGuide", "stores", "usageMethods"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if brand_addr (nullable) is None
        # and model_fields_set contains the field
        if self.brand_addr is None and "brand_addr" in self.model_fields_set:
            _dict['brandAddr'] = None
