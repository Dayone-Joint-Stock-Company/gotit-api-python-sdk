...
class VOUCHERE(BaseModel):
    ...
    vouchers: Optional[List[VOUCHERESCHEMA]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vouchers": [VOUCHERESCHEMA.from_dict(_item) for _item in obj["vouchers"]] if obj.get("vouchers") is not None else None
        })
        return _obj
