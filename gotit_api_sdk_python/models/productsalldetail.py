...
class PRODUCTSALLDETAIL(BaseModel):
    """
    PRODUCTSALLDETAIL
    """ # noqa: E501
    ...
    total_store: Optional[StrictInt] = Field(default=None, description="Total store", alias="totalStore")
    store_pagination: Optional[PAGINGSCHEMA] = Field(default=None, alias="storePagination")
    __properties: ClassVar[List[str]] = ["productId", "productNm", "productImg", "productDesc", "productShortDesc", "terms", "brandId", "brandNm", "brandLogo", "brandServiceGuide", "categoryId", "categoryNm", "categoryImg", "productType", "prices", "link", "storeList", "totalStore", "storePagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "storePagination": PAGINGSCHEMA.from_dict(obj["storePagination"]) if obj.get("storePagination") is not None else None
        })
        return _obj
