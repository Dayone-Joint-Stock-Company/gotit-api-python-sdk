...
class VOUCHERCHECKSCHEMA(BaseModel):
    """
    VOUCHERCHECKSCHEMA
    """ # noqa: E501
    ...
    vouchers: Optional[List[VOUCHERCHECKSCHEMADETAIL]] = None
    __properties: ClassVar[List[str]] = ["transactionRefId", "vouchers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vouchers": [VOUCHERCHECKSCHEMADETAIL.from_dict(_item) for _item in obj["vouchers"]] if obj.get("vouchers") is not None else None
        })
        return _obj
