...
def lazy_import():
    from gotit_api_sdk_python.model.productdefaultlinkg import PRODUCTDEFAULTLINKG
    globals()['PRODUCTDEFAULTLINKG'] = PRODUCTDEFAULTLINKG


class REQUESTCREATEVOUCHERLINKG(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'product_list': ([PRODUCTDEFAULTLINKG],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_list, order_name, expiry_date, transaction_ref_id, *args, **kwargs):  # noqa: E501
        """REQUESTCREATEVOUCHERLINKG - a model defined in OpenAPI

        Args:
            product_list ([PRODUCTDEFAULTLINKG]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_list, order_name, expiry_date, transaction_ref_id, *args, **kwargs):  # noqa: E501
        """REQUESTCREATEVOUCHERLINKG - a model defined in OpenAPI
