...
class REQUESTCREATEVOUCHERLINKV(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'product_price_id': (int,),  # noqa: E501
            ...
            'is_convert_to_cover_link': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'product_price_id': 'productPriceId',  # noqa: E501
        ...
        'is_convert_to_cover_link': 'isConvertToCoverLink',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_id, product_price_id, quantity, order_name, expiry_date, transaction_ref_id, *args, **kwargs):  # noqa: E501
        """REQUESTCREATEVOUCHERLINKV - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            use_otp (int): = 1 if the end user is required to enter a password to view the voucher. Example: 1. [optional]  # noqa: E501
            ...
            signature (str): RSA encryption, used for client authentication. [optional]  # noqa: E501
            active_date (str): Voucher validity start date, validity date must be greater than issue date. Format: 'YYYY-MM-DD'. Note: before this date, the voucher will be in Inactive status and cannot be used.. [optional]  # noqa: E501
            is_convert_to_cover_link (int): Type of voucher link to be issued: If = 0 (default): Create voucher link. If = 1: Create cover link for voucher link.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_id, product_price_id, quantity, order_name, expiry_date, transaction_ref_id, *args, **kwargs):  # noqa: E501
        """REQUESTCREATEVOUCHERLINKV - a model defined in OpenAPI
