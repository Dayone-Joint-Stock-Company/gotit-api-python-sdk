...
class REQUESTCREATEVOUCHERLINKV(BaseModel):
    """
    ...
    signature: Optional[StrictStr] = Field(default=None, description="RSA encryption, used for client authentication")
    active_date: Optional[StrictStr] = Field(default=None, description="Voucher validity start date, validity date must be greater than issue date. Format: 'YYYY-MM-DD'. Note: before this date, the voucher will be in Inactive status and cannot be used.", alias="activeDate")
    is_convert_to_cover_link: Optional[StrictInt] = Field(default=None, description="Type of voucher link to be issued: If = 0 (default): Create voucher link. If = 1: Create cover link for voucher link.", alias="isConvertToCoverLink")
    __properties: ClassVar[List[str]] = ["productId", "productPriceId", "quantity", "orderName", "expiryDate", "transactionRefId", "use_otp", "otp_type", "password", "receiver_name", "phone", "email", "signature", "activeDate", "isConvertToCoverLink"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isConvertToCoverLink": obj.get("isConvertToCoverLink")
        })
        return _obj
