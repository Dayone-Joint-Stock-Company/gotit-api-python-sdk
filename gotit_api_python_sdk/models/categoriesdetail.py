...
class CATEGORIESDETAIL(BaseModel):
    ...
    slug: Optional[StrictStr] = Field(default=None, description="Category Slug")
    order: Optional[StrictInt] = Field(default=None, description="Category Short")
    __properties: ClassVar[List[str]] = ["categoryId", "categoryNm", "categoryImg", "slug", "order"]
